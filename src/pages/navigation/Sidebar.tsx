        ...
        <section className="sidebar w-full h-full pt-5">
            <ul className="flex flex-col justify-center items-center gap-3">
                <li className="py-2 w-1/2">
                    <NavLink to="/dashboard/home" state={'home'} className="flex flex-wrap items-center gap-2 text-lg">
                        <FaHouseUser />
                        <span>Home</span>
                    </NavLink>
                </li>
                ...
                <li className="py-2 w-1/2">
                    <NavLink to="/dashboard/controls" state={'controls'} className="flex flex-wrap items-center gap-2 text-lg">
                        <FaCheckDouble />
                        <span>Controls</span>
                    </NavLink>
                </li>
